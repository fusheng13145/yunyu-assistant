  ...
  <div
    ...
    <div class="w-full max-w-md mx-4">
      ...
      <div class="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl ring-1 ring-white/20 p-8">
        ...
        <div class="mt-4 bg-blue-400/15 rounded-xl p-3.5 ring-1 ring-blue-400/20">
          <div class="flex items-start gap-2">
            ...
            <div class="text-blue-200/90 text-sm leading-relaxed">
              <p class="font-semibold mb-1">注册须知</p>
              <p>用户名唯一，密码至少6位。注册成功后将自动登录。</p>
            </div>
          </div>
        </div>
        ...
        <button @click="handleRegister" :disabled="loading || !canSubmit" :class="[
        ...
        <div class="mt-6 text-center">
          <span class="text-white/60">已有账号？</span>
      ...
      <div class="mt-6 bg-amber-400/20 backdrop-blur-lg rounded-2xl ring-2 ring-amber-400/50 p-5 shadow-lg">
        ...
        <p class="text-amber-200/70 text-xs mt-3">不想注册？直接使用体验账号登录，已预置3个智能助手</p>
      </div>
    </div>
  </div>
</template>
