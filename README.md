...
| `RAGFLOW_API_KEY` / `RAGFLOW_ENDPOINT` | RAGFlow 知识库服务（可选；未配置或密钥失效时**对话不报错**，但本轮检索判为失败：后端记 WARN、`query_end.knowledgebase.failed=true`，v2.39） |
