...
│                            # check-auth-session.mjs（前端会话逻辑门禁）
...
├── .github/workflows/ci.yml # PR 关键路径：后端单测 + 前端四检 + 门禁（零凭据、零数据库，v2.33）
