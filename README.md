...
- **P2 规模运营与体验优化**：✅ 通话录音与回放 + 弱网降级 + ICE 可配置化（TURN 部署待实施） · ✅ 长会话消息惰性分页（归档与容量治理进行中） · 多租户与商业化前置
