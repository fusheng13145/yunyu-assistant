...
- 可选：`OPENAI_BASE_URL` / `RAGFLOW_*` / `RUSTPBX_ENDPOINT` / `SEARCH_*` / `WEATHER_API_KEY` / `HEALTH_SHOW_DETAILS` / `MAPPER_LOG_LEVEL` / `LOG_FILE` 等
